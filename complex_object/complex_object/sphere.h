...
public:
	...
	static int Sphere::createSphere(int numLong, int numLat, Vertices &vtx, Indices &ind, Vector4f colour);
	int createGeom(int numLongs, int numLat);

	//removed because doing the exact same thing as graphicsObject.cpp
